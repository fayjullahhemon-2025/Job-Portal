                                            ...
                                            <div class="flex flex-col justify-center h-full p-12">
                                                ...
                                                <form action="register.php" method ="post"class="mt-8">
                                                    ...
                                                    <div class="my-5 text-center">
                                                        <button type="submit" value="register" name="submit" class="btn w-full bg-white text-gray-900 font-medium border-transparent hover:-translate-y-1.5 duration-500 ease">Sign Up
                                                    </button></div>
                                                </form>
                                                <div class="text-center">
                                                    <p class="text-white">Already a member ? <a href="sign-in.php" class="text-white underline fw-medium"> Sign In </a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
