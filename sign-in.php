                                            ...
                                            <div class="flex flex-col justify-center h-full p-12">
                                                ...
                                                <form action="login.php" method="post" class="mt-8">
                                                    ...
                                                    <div class="my-8 text-center">
                                                        <button type="submit" value="submit" name="login" class="btn w-full bg-white text-gray-900 font-medium border-transparent hover:-translate-y-1.5 duration-500 ease">Sign In
                                                    </button></div>
                                                </form>
                                                <div class="text-center">
